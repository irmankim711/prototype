...
export default function FormBuilderAdmin() {
  ...
  const handleManageQR = (form: Form) => {
    setSelectedFormForQR(form);
    setTabValue(2); // Switch to QR Code tab
  };
  ...
  return (
    <Box sx={{ width: "100%", typography: "body1" }}>
                ...
                <Card>
                  ...
                  <CardActions>
                    ...
                    <Button
                      ...
                      startIcon={<QrCode />}
                      onClick={() => {
                        // Generate QR code for external form
                        setSnackbar({
                          open: true,
      ...
      <TabPanel value={tabValue} index={2}>
        {selectedFormForQR ? (
          ...
          <Paper sx={{ p: 4, textAlign: "center" }}>
            ...
            <Typography variant="h6" gutterBottom>
              Select a Form to Manage QR Codes
            </Typography>
            <Typography color="text.secondary" paragraph>
              Go to the "My Forms" tab and click "QR Codes" on any form to
              manage its QR codes.
            </Typography>
      ...
      >
        ...
        <MenuItem onClick={() => selectedForm && handleManageQR(selectedForm)}>
          <QrCode sx={{ mr: 1 }} /> Manage QR Codes
        </MenuItem>
        <Divider />
        <MenuItem
          onClick={() => {
