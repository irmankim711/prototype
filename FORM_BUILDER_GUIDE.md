...
export const formBuilderAPI = {
  ...
  updateForm: (formId: number, formData: UpdateFormData) =>
    Promise<FormResponse>,
  deleteForm: (formId: number) => Promise<void>,
  getFieldTypes: () => Promise<FormBuilderConfig>,
  submitForm: (formId: number, data: SubmitFormData) =>
    Promise<SubmissionResponse>,
  getFormSubmissions: (formId: number, params?: SubmissionQueryParams) =>
