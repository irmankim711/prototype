...
def register_routes():
    ...
    try:
        ...
        blueprints['templates_api'] = templates_api
        logger.info("✅ Templates API routes imported successfully")
    except ImportError:
        logger.info("ℹ️ Templates API routes not available, skipping")

    try:
        from .excel_to_pdf_api import excel_to_pdf_bp
        blueprints['excel_to_pdf'] = excel_to_pdf_bp
        logger.info("✅ Excel-to-PDF API routes imported successfully")
    except ImportError:
        logger.info("ℹ️ Excel-to-PDF API routes not available, skipping")
