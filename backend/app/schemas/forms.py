...
class FormCreateRequest(BaseRequestSchema):
    ...
    @classmethod
    def validate_fields(cls, v: List[FormFieldSchema]) -> List[FormFieldSchema]:
        ...
        # Note: The enable_file_uploads check should be done at form level, not field level
        # This validation needs to be adjusted based on actual form structure
