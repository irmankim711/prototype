...
from typing import Any, Dict, List, Optional, Union, Generic, TypeVar, Annotated
from pydantic import BaseModel, Field, field_validator, model_validator, ConfigDict, AfterValidator
...
# Type alias for sanitized string fields
SanitizedString = Annotated[str, AfterValidator(sanitize_string)]
...
# Type alias for sanitized HTML fields
SanitizedHTML = Annotated[str, AfterValidator(sanitize_html)]
