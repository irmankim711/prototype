...
class FileSearchRequest(BaseRequestSchema):
    ...
    def validate_size_range(cls, values):
        ...
        if hasattr(values, 'min_size') and hasattr(values, 'max_size'):
    ...
    def validate_date_ranges(cls, values):
        ...
        if hasattr(values, 'uploaded_after') and hasattr(values, 'uploaded_before'):
        ...
        if hasattr(values, 'modified_after') and hasattr(values, 'modified_before'):
...
class FileProcessingRequest(BaseRequestSchema):
    ...
    @classmethod
    def validate_resize_dimensions(cls, v: Optional[Dict[str, int]]) -> Optional[Dict[str, int]]:
    ...
    @field_validator('compress_quality')
    @classmethod
    def validate_compress_quality(cls, v: Optional[int]) -> Optional[int]:
