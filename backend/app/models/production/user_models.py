...
This model matches the existing Supabase database structure and supports Firebase auth.
"""

from sqlalchemy import Column, String, Text, DateTime, Boolean, JSON, ForeignKey, Integer, SmallInteger, Enum
...
class User(db.Model):
    ...
    # For Firebase-authenticated users, password_hash may be null
    password_hash = Column(String(255), nullable=True)
    # Firebase UID for linking Firebase accounts
