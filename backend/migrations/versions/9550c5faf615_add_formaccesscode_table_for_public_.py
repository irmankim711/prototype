"""Add FormAccessCode table for public form builder

Revision ID: 9550c5faf615
Revises: aafda9d95835
Create Date: 2025-08-03 23:29:13.974703
...
revision = '9550c5faf615'
down_revision = 'aafda9d95835'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('form_access_codes',
    ...
    with op.batch_alter_table('form_qr_code', schema=None) as batch_op:
...
def downgrade():
    ...
    sa.UniqueConstraint('form_id', 'date', name='form_analytics_form_id_date_key')
    )
    with op.batch_alter_table('form_analytics', schema=None) as batch_op:
    ...
    sa.UniqueConstraint('organization_id', 'name', name='integrations_organization_id_name_key'),
    ...
    sa.UniqueConstraint('organization_id', 'name', name='report_categories_organization_id_name_key'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.UniqueConstraint('organization_id', 'name', name='roles_organization_id_name_key')
    )
    ...
    sa.UniqueConstraint('organization_id', 'name', name='form_categories_organization_id_name_key'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.UniqueConstraint('organization_id', 'slug', name='forms_organization_id_slug_key'),
    ...
    sa.UniqueConstraint('organization_id', 'name', 'type', name='notification_templates_organization_id_name_type_key')
    )
    op.drop_table('form_access_codes')
    # ### end Alembic commands ###
